use crate::{
    ...
    derived_parametric_crs::base_parametric_crs::BaseParametricCrs,
    error::WktParseError,
...
impl TryFrom<&WktNode> for DerivedParametricCrs {
    ...
    fn try_from(value: &WktNode) -> Result<Self, Self::Error> {
        ...
        let base_parametric_crs = match &value.args[1] {
            WktArg::Node(node) => BaseParametricCrs::try_from(node)?,
