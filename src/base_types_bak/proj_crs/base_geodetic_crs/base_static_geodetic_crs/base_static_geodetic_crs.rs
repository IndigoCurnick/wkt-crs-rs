use crate::{
    ...
    keywords::{ANGLEUNIT, BASEGEODCRS, DATUM, ENSEMBLE, GEODETICDATUM, ID, PRIMEM, TRF, UNIT},
...
impl TryFrom<&WktNode> for BaseStaticGeodeticCrs {
    ...
    fn try_from(value: &WktNode) -> Result<Self, Self::Error> {
        ...
        return Ok(BaseStaticGeodeticCrs {
            base_crs_name,
            geodetic_data,
            ellipsoidal_cs_unit,
            identifier,
