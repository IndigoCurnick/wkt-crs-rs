...
use crate::{
    ...
    keywords::{LENGTHUNIT, USAGE},
    prime_meridian::PrimeMeridian,
    scope_extent_identifier_remark::{
        AreaDescription, DateOrString, Extent, GeographicBoundingBox, Id, Remark, Scope,
        ScopeExtentIdentifierRemark, TemporalExtent, Usage,
    },
...
fn test_example_1() {
    let correct = GeodeticCrs::StaticGeodeticCrs(StaticGeodeticCrs {
        ...
        frame: GeodeticData::GeodeticReferenceFrame(GeodeticReferenceFrameDatum {
        ...
        scope_extent_identifier_remark: ScopeExtentIdentifierRemark {
            usage: Some(vec![Usage {
                scope: Scope("Geodesy, topographic mapping and cadastre".into()),
                extent: Extent {
            ...
            identifier: Some(vec![Id {
                ...
                authority_unique_identifier: NumText::Num(4946.0),
                version: None,
    ...
    let geo = GeodeticCrs::try_from(&ast[0]).unwrap();

    assert_eq!(geo, correct);
}

fn test_example_2() {
    let correct =
        GeodeticCrs::GeographicCrs(GeographicCrs::DynamicGeographicCrs(DynamicGeographicCrs {
            ...
            geodetic_reference_frame: GeodeticReferenceFrameDatum {
...
fn test_example_3() {
    let correct =
        GeodeticCrs::GeographicCrs(GeographicCrs::StaticGeographicCrs(StaticGeographicCrs {
            crs_name: "NAD83".into(),
            frame: GeodeticData::GeodeticReferenceFrame(GeodeticReferenceFrameDatum {
            ...
            scope_extent_identifier_remark: ScopeExtentIdentifierRemark {
                ...
                identifier: Some(vec![Id {
                    authority_name: "EPSG".into(),
                    authority_unique_identifier: NumText::Num(4269.0),
                    authority_citation: None,
                    id_uri: None,
                    version: None,
                }]),
                remark: Some(Remark {
                    remark: "1986 realisation".into(),
                }),
            },
        }));
    ...
    let correct =
        GeodeticCrs::GeographicCrs(GeographicCrs::StaticGeographicCrs(StaticGeographicCrs {
            ...
            scope_extent_identifier_remark: ScopeExtentIdentifierRemark {
                ...
                identifier: None,
                remark: Some(Remark {
                    remark: "Nouvelle Triangulation Française".into(),
                }),
            },
        }));
