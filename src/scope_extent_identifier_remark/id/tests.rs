use crate::{ast::parse_wkt, uri::Uri, utils::NumText};
...
const EXAMPLE4: &str = r#"ID["EuroGeographics","ES_ED50 (BAL90) to ETRS89","2001-04-20"]"#;
...
fn test_id() {
    ...
    let correct = Id {
        ...
        authority_unique_identifier: NumText::Num(4326.0),
        version: None,
        authority_citation: None,
        id_uri: None,
    };
