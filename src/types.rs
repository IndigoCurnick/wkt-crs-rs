use crate::{
    ...
    base_types::{
        ...
        CompoundCrs, CoordinateEpoch, CoordinateMetadata, CoordinateOperation, CoordinateSystem,
        DatumAnchor, DatumEnsembleAccuracy, DatumEnsembleMember, DeformationModelId,
        DerivedCrsConversionMethod, DerivedEngineeringCrs, DerivedGeodeticCrs,
        ...
        GeographicBoundingBox, GeographicCrs, GeoidModelId, Id, InterpolationCrs, LengthUnit,
        MapProjection, MapProjectionMethod, MapProjectionParameter, Meridian, OperationAccuracy,
        OperationMethod, OperationParameter, OperationParameterFile, OperationVersion, Order,
        ParametricCrs, ParametricDatum, ParametricUnit, PointMotionOperation, PrimeMeridian,
        ProjectedCrs, Remark, ScaleUnit, Scope, SourceCrs, TargetCrs, TemporalDatum,
        TemporalExtent, TimeCrs, TimeOrigin, TimeUnit, Usage, VerticalCrs, VerticalDatumEnsemble,
