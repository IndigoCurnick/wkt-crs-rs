use crate::{
    ast::parse_wkt,
    base_types::{
        AngleUnit, AreaDescription, ConcatenatedOperation, CoordinateSystem, Ellipsoid, Extent,
        GeodeticCrs, GeodeticReferenceFrame, Id, LengthUnit, MapProjection, MapProjectionMethod,
        MapProjectionParameter, OperationAccuracy, Order, Scope, SourceCrs, SpatialAxis,
    ...
    let correct = ConcatenatedOperation {
        ...
        scope_extent_identifier_remark: ScopeExtentIdentifierRemark {
            usage: Some(vec![Usage {
                scope: Scope("Concatendated operation scope description.".into()),
                extent: Extent {
