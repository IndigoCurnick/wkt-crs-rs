use crate::{
    ast::parse_wkt,
    base_types::{
        CoordinateSystem, DatumAnchor, EngineeringDatum, Extent, Id, LengthUnit, Order,
        OrdinalDateTimeAxis, OrdinalDateTimeCoordinateSystem, Scope, SpatialAxis,
        SpatialCoordinateSystem, TemporalExtent, Usage,
    },
...
fn test_example_1() {
    ...
    let eng = EngineeringCrs::from_nodes(&ast).unwrap();

    assert_eq!(correct, eng.result);
}
    ...
    let correct = EngineeringCrs {
        ...
        scope_extent_identifier_remark: ScopeExtentIdentifierRemark {
            ...
            identifier: Some(vec![Id {
                ...
                authority_unique_identifier: NumText::Int(5800),
                version: None,
