use crate::{
	...
	ast::{Parse, WktNode},
	base_types::{BaseStaticCrs, CoordinateSystem, DerivingConversion},
...
pub struct DerivedStaticGeodCrs {
...
impl WktBaseType for DerivedStaticGeodCrs {
	fn from_nodes<'a, I>(
		wkt_nodes: I,
