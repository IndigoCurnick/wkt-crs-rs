use crate::{
	...
	ast::{Parse, WktNode},
	base_types::{BaseDynamicCrs, CoordinateSystem, DerivingConversion},
...
pub struct DerivedDynamicGeogCrs {
...
impl WktBaseType for DerivedDynamicGeogCrs {
	fn from_nodes<'a, I>(
		wkt_nodes: I,
		...
		I: IntoIterator<Item = &'a WktNode>,
	{
		...
		let base_dynamic_crs = node.args[1].parse()?;
