...
use crate::{
    ast::parse_wkt,
    base_types::{
        AngleUnit, Bearing, LengthUnit, Meridian, Order, OrdinalDateTimeAxis, SpatialAxis,
        coordinate_system::{OrdinalDateTimeCoordinateSystem, SpatialCoordinateSystem},
    },
    compound_types::{SpatialUnit, Unit},
    enumerations::{AxisDirection, Dimension, OrdinalDateTimeCsType, SpatialCsType},
    types::WktBaseType,
};
    ...
    let correct = CoordinateSystem::SpatialCS(SpatialCoordinateSystem {
        ...
        spatial_axis: vec![
            ...
            SpatialAxis {
                ...
                axis_direction: AxisDirection::CounterClockwise(Bearing(0.0)),
                axis_order: Some(Order(2)),
                identifier: None,
    ...
    let correct = CoordinateSystem::SpatialCS(SpatialCoordinateSystem {
        ...
        spatial_axis: vec![
            ...
            SpatialAxis {
                ...
                axis_direction: AxisDirection::Clockwise(Bearing(234.0)),
                axis_order: Some(Order(2)),
                identifier: None,
                spatial_unit: Some(SpatialUnit::AngleUnit(AngleUnit {
                    unit_name: "degree".to_string(),
