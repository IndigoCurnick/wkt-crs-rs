	...
	let correct = CoordinateSystem::SpatialCS(SpatialCoordinateSystem {
		...
		spatial_axis: vec![
			Axis {
				...
				axis_order: Some(Order(1)),
				identifier: None,
				unit: Some(Unit::SpatialUnit(SpatialUnit::LengthUnit(
					LengthUnit {
			...
			Axis {
				...
				axis_order: Some(Order(2)),
				identifier: None,
				unit: Some(Unit::SpatialUnit(SpatialUnit::AngleUnit(
					AngleUnit {
...
fn test_example_17() {
	let correct =
		CoordinateSystem::OrdinalDateTimeCS(OrdinalDateTimeCoordinateSystem {
