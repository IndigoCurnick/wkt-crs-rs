use wkt_crs_rs::{
	...
	base_types::{
		...
		GeodeticCrs, GeodeticReferenceFrame, GeographicCrs, Id, LengthUnit,
...
#[test]
fn test_epsg_crs_10628() {
	let inner = GeodeticCrs::GeographicCrs(GeographicCrs::StaticGeographicCrs(
		StaticGeographicCrs {
			...
			defining_transformation_id: Some(DefiningTransformation {
				defining_transformation_name: "ETRS89 to WC05-IRF (1)"
					.to_string(),
	...
	let correct = vec![WktCrsTypes::GeodeticCrs(inner)];
