use wkt_crs_rs::{
    WktCrsTypes,
    base_types::{
        AngleUnit, BaseGeodeticCrs, BaseStaticGeographicCrs, CoordinateSystem, Ellipsoid,
        GeodeticDatumEnsemble, GeodeticReferenceFrame, Id, LengthUnit, MapProjection,
        MapProjectionMethod, MapProjectionParameter, ProjectedCrs, ScaleUnit, SpatialAxis,
    ...
    let insider = ProjectedCrs {
        ...
        base_geodetic_crs: BaseGeodeticCrs::BaseStaticGeographicCrs(BaseStaticGeographicCrs {
            ...
            geodetic_data: GeodeticData::GeodeticReferenceFrame(GeodeticReferenceFrame {
                datum_name: "NAD83 (High Accuracy Reference Network)".to_string(),
                ellipsoid: Ellipsoid {
        ...
        map_projection: MapProjection {
            map_projection_name: "SPCS83 Maine West zone (US survey foot)".to_string(),
